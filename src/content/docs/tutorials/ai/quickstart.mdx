...
For model name formats, configuration options, and 100+ additional providers (Azure, AWS Bedrock, Vertex AI, Groq, etc.), see the [byLLM Reference](/reference/plugins/byllm/#supported-providers) and [LiteLLM documentation](https://docs.litellm.ai/docs/providers).
...
**Advanced:** For custom/self-hosted models with HTTP client, see [byLLM Reference](/reference/plugins/byllm/#project-configuration).
...
- [Structured Outputs](/tutorials/ai/structured-outputs/) - Return enums, objects, and lists
- [Agentic AI](/tutorials/ai/agentic/) - Tool calling and ReAct patterns
- [Part 2: Add AI](/tutorials/first-app/part2-ai-features/) - See AI integration in a complete full-stack app
