...
Want to see exactly how much code Jac eliminates? Check out [Jac vs Traditional Stack](/quick-guide/jac-vs-traditional-stack/) - a side-by-side comparison showing **~30 lines of Jac** vs **>300 lines** of Python + FastAPI + SQLite + TypeScript + React for the same Todo app.
:::
...
### Just want to try it?
    ...
    Follow the [Hello World](/quick-guide/hello-world/) guide to write your first program in 2 minutes.

### Building a web app?

    ---

    Jump to [Build Your First App](/tutorials/first-app/part1-todo-app/) - build a complete app with a 3-part tutorial.

### Working with AI/LLMs?

    ---

    See the [AI Integration tutorial](/tutorials/ai/quickstart/) for byLLM basics, or try [Part 2: Add AI](/tutorials/first-app/part2-ai-features/) in the first app tutorial.

### Want the full picture?

    ---

    Read [Next Steps](/quick-guide/next-steps/) for learning paths by experience level.
...
|----------|-------------|
| [Installation](/quick-guide/install/) | Detailed setup with IDE configuration |
| [Hello World](/quick-guide/hello-world/) | Your first Jac program (2 min) |
| [Build Your First App](/tutorials/first-app/part1-todo-app/) | Complete 3-part tutorial: todo app, AI, walkers |
| [Tutorials](/tutorials/) | In-depth learning paths |
| [Language Reference](/reference/language/) | Complete language documentation |
