---
title: Jac-Super Release Notes
---# Jac-Super Release Notes

This document provides a summary of new features, improvements, and bug fixes in each version of **Jac-Super**. For details on changes that might require updates to your existing code, please refer to the [Breaking Changes](/community/breaking-changes/) page.
